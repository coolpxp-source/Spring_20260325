...
<head>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f4b72986716b1d237aaa41d1abe4efb0&libraries=services"></script>
    <style>
        table, tr, td, th{
...
<body>
    <div id="app">
        ...
        <div>
            <select @change="fnSearch()" v-model="category">
